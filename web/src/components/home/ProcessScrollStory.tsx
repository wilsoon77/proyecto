...
const PHASES: PhaseContent[] = [
  {
    ...
    description: "Iniciamos con mezclas de harinas finas de trigo, masa madre viva e ingredientes naturales puros sin conservantes artificiales.",
    badge: "Masa Madre Activa",
    icon: Wheat,
    position: "left",
  },
  {
    ...
    title: "Técnica y Elasticidad a Mano",
    description: "El amasado manual desarrolla la malla de gluten perfecta, otorgando a cada miga su ligereza y suavidad característica.",
    badge: "Amasado Manual",
    icon: Sparkles,
    position: "right",
  },
  {
    id: 3,
    range: [0.40, 0.58],
    step: "03 / 05 · LEUDADO LENTO",
    title: "Reposo y Fermentación Natural",
    description: "El tiempo es nuestro mejor ingrediente. Cada porción descansa en reposo controlado para despertar aromas profundos.",
    badge: "Fermentación Prolongada",
    icon: Timer,
    position: "left",
  },
  {
    ...
    title: "Corteza Crujiente y Dorada",
    description: "2 hornadas diarias a 5:00 AM y 2:00 PM. El calor uniforme carameliza los azúcares naturales para lograr un dorado perfecto.",
  ...
  },
  {
    ...
    title: "Conchas y Tradición en tu Mesa",
    description: "El resultado: conchas de vainilla y chocolate, panes tradicionales y repostería recién salida del horno, lista para ti.",

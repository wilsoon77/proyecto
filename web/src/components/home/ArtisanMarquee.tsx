...
const DEFAULT_MARQUEE_ITEMS: MarqueeItem[] = [
  {
    icon: Wheat,
    title: "Harinas Seleccionadas",
    subtitle: "Miga suave y dorado parejo",
    tag: "Calidad",
  },
  {
    icon: Clock3,
    title: "Leudado Natural",
    subtitle: "Tiempo y paciencia en cada masa",
    tag: "Proceso",
  },
  {
    icon: Flame,
  ...
  },
  {
    ...
    subtitle: "El sabor y sazón tradicional",
    tag: "Tradición",
  },
  {
    icon: Milk,
    title: "Mantequilla y Leche Fresca",
    subtitle: "Rico aroma y textura suave",
    tag: "Ingrediente",
  },
  {
    icon: Award,
    title: "Pan Dulce y Salado",
    subtitle: "Conchas, champurradas y pan francés",
    tag: "Variedad",
  },
  {
    icon: Users,
    title: "Para Toda la Familia",
    subtitle: "El centro de tu mesa cada día",
    tag: "Hogar",
  },
  {
    icon: HeartHandshake,
    title: "Hecho en Chimaltenango",
    subtitle: "Cerca de ti y de tus vecinos",
    tag: "Comunidad",
  },
  {
    icon: ShieldCheck,
    title: "Horneado al Día",
    subtitle: "Pan fresco sin guardar de días pasados",
    tag: "Frescura",
  },
  {
    icon: Leaf,
    title: "Empaque Práctico",
    subtitle: "Listo y protegido para llevar a casa",
    tag: "Servicio",
  },
]

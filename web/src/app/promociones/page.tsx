...
const PROMOS = [
  ...
  { id: 2, title: "2x1 en galletas", desc: "Sábados de 3 a 5 pm.", badge: "HOY", color: "bg-primary/10 text-primary" },
...
export default function PromocionesPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="mb-2 text-3xl font-bold text-foreground">Promociones</h1>
      <p className="mb-8 text-muted-foreground">Aprovecha nuestras ofertas por tiempo limitado.</p>
